...
PRICES = {
    ...
    "торревьеха":  {"эконом": 20, "комфорт": 32, "suv": 45, "минивэн": 55},
    "гандия":      {"эконом": 22, "комфорт": 35, "suv": 48, "минивэн": 58},
    "дения":       {"эконом": 22, "комфорт": 35, "suv": 48, "минивэн": 58},
    "марбелья":    {"эконом": 28, "комфорт": 42, "suv": 55, "минивэн": 65},
}
...
async def menu_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "menu_apply":
        ...
        await query.message.reply_text(
            ...
            "• Максимум — €30/сутки: колёса, стёкла, эвакуатор, ассистанс + "
